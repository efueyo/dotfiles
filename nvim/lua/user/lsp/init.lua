...
local servers = {
	...
	nixd = {
		...
		options = {
			nixos = {
				expr = '(builtins.getFlake "/home/efueyo/repos/dotfiles/flake.nix").nixosConfigurations.nixos.options',
			},
			home_manager = {
				expr = '(builtins.getFlake "/home/efueyo/repos/dotfiles/flake.nix").homeConfigurations.nixos.options',
			},
		},
	},
}
